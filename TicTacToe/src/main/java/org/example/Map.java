...
public class Map extends JPanel {
    ...
    int size=3;
    private int fieldSizeY = size;
    private int fieldSizeX = size;
    public char[][] field;
    ...
    /**
     * Проверка на пустоту в клетках поля
     *
     * @param x координата
     * @param y координата
     */
    ...
    /**
     * Метод делает ход со стороны соперника
     */
    private void aiTurn() {
        int x, y;
        do {
    ...
    protected boolean checkWin(int c) {
        for (int y = 0; y < fieldSizeY; y++) {
            int check = 0;
            for (int x = 0; x < fieldSizeX; x++) {
